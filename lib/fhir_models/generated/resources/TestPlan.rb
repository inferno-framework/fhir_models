  ...
  module build.fhir.org
    class TestPlan < Model
      ...
      METADATA = {
        ...
        'scope' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'type'=>'Reference', 'path'=>'TestPlan.scope', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Dependency < Model
        ...
        METADATA = {
          ...
          'predecessor' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/TestPlan'], 'type'=>'Reference', 'path'=>'Dependency.predecessor', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :predecessor       # 0-1 Reference(TestPlan)
      end
      ...
      class TestCase < Model
        ...
        METADATA = {
          ...
          'key' => {'type'=>'id', 'path'=>'TestCase.key', 'min'=>1, 'max'=>1},
          'description' => {'type'=>'markdown', 'path'=>'TestCase.description', 'min'=>0, 'max'=>1},
          'sequence' => {'type'=>'integer', 'path'=>'TestCase.sequence', 'min'=>0, 'max'=>1},
          'scope' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'type'=>'Reference', 'path'=>'TestCase.scope', 'min'=>0, 'max'=>Float::INFINITY},
          'requirement' => {'type'=>'TestPlan::TestCase::Requirement', 'path'=>'TestCase.requirement', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        class Dependency < Model
          ...
          METADATA = {
            ...
            'modifierExtension' => {'type'=>'Extension', 'path'=>'Dependency.modifierExtension', 'min'=>0, 'max'=>Float::INFINITY},
            'description' => {'type'=>'markdown', 'path'=>'Dependency.description', 'min'=>0, 'max'=>1},
            'reference' => {'type'=>'canonical', 'path'=>'Dependency.reference', 'min'=>0, 'max'=>1},
            'key' => {'type'=>'id', 'path'=>'Dependency.key', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :modifierExtension # 0-* [ Extension ]
          attr_accessor :description       # 0-1 markdown
          attr_accessor :reference         # 0-1 canonical
          attr_accessor :key               # 0-1 id
        end
        ...
        class TestRun < Model
          ...
          class Script < Model
            ...
            METADATA = {
              ...
              'sourceReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'type'=>'Reference', 'path'=>'Script.source[x]', 'min'=>0, 'max'=>1}
            }
            ...
            attr_accessor :sourceReference   # 0-1 Reference(Resource)
          end
        ...
        class TestData < Model
          ...
          METADATA = {
            ...
            'content' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'type'=>'Reference', 'path'=>'TestData.content', 'min'=>0, 'max'=>1},
            'sourceString' => {'type'=>'string', 'path'=>'TestData.source[x]', 'min'=>0, 'max'=>1},
            'sourceReference' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Resource'], 'type'=>'Reference', 'path'=>'TestData.source[x]', 'min'=>0, 'max'=>1}
          }
          ...
          attr_accessor :content           # 0-1 Reference(Resource)
          attr_accessor :sourceString      # 0-1 string
          attr_accessor :sourceReference   # 0-1 Reference(Resource)
        end
        ...
        attr_accessor :scope             # 0-* [ Reference(Resource) ]
        attr_accessor :requirement       # 0-* [ TestPlan::TestCase::Requirement ]
