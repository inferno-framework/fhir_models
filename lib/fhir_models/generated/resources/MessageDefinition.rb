module FHIR
  module build.fhir.org
    class MessageDefinition < Model
      ...
      SEARCH_PARAMS = ['category', 'context', 'context-quantity', 'context-type', 'context-type-quantity', 'context-type-value', 'date', 'description', 'event', 'focus', 'identifier', 'jurisdiction', 'name', 'publisher', 'status', 'title', 'url', 'version']
      METADATA = {
        ...
        'language' => {'type'=>'code', 'path'=>'MessageDefinition.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'versionAlgorithmString' => {'type'=>'string', 'path'=>'MessageDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'type'=>'Coding', 'path'=>'MessageDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        ...
        'copyrightLabel' => {'type'=>'string', 'path'=>'MessageDefinition.copyrightLabel', 'min'=>0, 'max'=>1},
        ...
        'graph' => {'type'=>'canonical', 'path'=>'MessageDefinition.graph', 'min'=>0, 'max'=>1}
      }
      ...
      attr_accessor :graph                  # 0-1 canonical
