  ...
  module build.fhir.org
    class RegulatedAuthorization < Model
      ...
      METADATA = {
        ...
        'meta' => {'type'=>'Meta', 'path'=>'RegulatedAuthorization.meta', 'min'=>0, 'max'=>1},
        'implicitRules' => {'type'=>'uri', 'path'=>'RegulatedAuthorization.implicitRules', 'min'=>0, 'max'=>1},
        'language' => {'type'=>'code', 'path'=>'RegulatedAuthorization.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        'text' => {'type'=>'Narrative', 'path'=>'RegulatedAuthorization.text', 'min'=>0, 'max'=>1},
        'contained' => {'type'=>'Resource', 'path'=>'RegulatedAuthorization.contained', 'min'=>0, 'max'=>Float::INFINITY},
        'extension' => {'type'=>'Extension', 'path'=>'RegulatedAuthorization.extension', 'min'=>0, 'max'=>Float::INFINITY},
        'modifierExtension' => {'type'=>'Extension', 'path'=>'RegulatedAuthorization.modifierExtension', 'min'=>0, 'max'=>Float::INFINITY},
        'identifier' => {'type'=>'Identifier', 'path'=>'RegulatedAuthorization.identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'subject' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/MedicinalProductDefinition', 'http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct', 'http://hl7.org/fhir/StructureDefinition/NutritionProduct', 'http://hl7.org/fhir/StructureDefinition/PackagedProductDefinition', 'http://hl7.org/fhir/StructureDefinition/ManufacturedItemDefinition', 'http://hl7.org/fhir/StructureDefinition/Ingredient', 'http://hl7.org/fhir/StructureDefinition/SubstanceDefinition', 'http://hl7.org/fhir/StructureDefinition/DeviceDefinition', 'http://hl7.org/fhir/StructureDefinition/ResearchStudy', 'http://hl7.org/fhir/StructureDefinition/ActivityDefinition', 'http://hl7.org/fhir/StructureDefinition/PlanDefinition', 'http://hl7.org/fhir/StructureDefinition/ObservationDefinition', 'http://hl7.org/fhir/StructureDefinition/Practitioner', 'http://hl7.org/fhir/StructureDefinition/Organization', 'http://hl7.org/fhir/StructureDefinition/Location'], 'type'=>'Reference', 'path'=>'RegulatedAuthorization.subject', 'min'=>0, 'max'=>Float::INFINITY},
        'type' => {'valid_codes'=>{'http://hl7.org/fhir/regulated-authorization-type'=>['MarketingAuth', 'Orphan', 'Pediatric']}, 'type'=>'CodeableConcept', 'path'=>'RegulatedAuthorization.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/regulated-authorization-type'}},
        'description' => {'type'=>'markdown', 'path'=>'RegulatedAuthorization.description', 'min'=>0, 'max'=>1},
        ...
        'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'type'=>'CodeableConcept', 'path'=>'RegulatedAuthorization.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
        'statusDate' => {'type'=>'dateTime', 'path'=>'RegulatedAuthorization.statusDate', 'min'=>0, 'max'=>1},
        'validityPeriod' => {'type'=>'Period', 'path'=>'RegulatedAuthorization.validityPeriod', 'min'=>0, 'max'=>1},
        'indication' => {'type'=>'CodeableReference', 'path'=>'RegulatedAuthorization.indication', 'min'=>0, 'max'=>Float::INFINITY},
        'intendedUse' => {'valid_codes'=>{'http://hl7.org/fhir/product-intended-use'=>['Prevention', 'Treatment', 'Alleviation', 'Diagnosis', 'Monitoring']}, 'type'=>'CodeableConcept', 'path'=>'RegulatedAuthorization.intendedUse', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/product-intended-use'}},
        ...
        'holder' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'type'=>'Reference', 'path'=>'RegulatedAuthorization.holder', 'min'=>0, 'max'=>1},
        'regulator' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Organization'], 'type'=>'Reference', 'path'=>'RegulatedAuthorization.regulator', 'min'=>0, 'max'=>1},
        'attachedDocument' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/DocumentReference'], 'type'=>'Reference', 'path'=>'RegulatedAuthorization.attachedDocument', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Case < Model
        ...
        METADATA = {
          'id' => {'type'=>'string', 'path'=>'Case.id', 'min'=>0, 'max'=>1},
          'extension' => {'type'=>'Extension', 'path'=>'Case.extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'type'=>'Extension', 'path'=>'Case.modifierExtension', 'min'=>0, 'max'=>Float::INFINITY},
          'identifier' => {'type'=>'Identifier', 'path'=>'Case.identifier', 'min'=>0, 'max'=>1},
          'type' => {'valid_codes'=>{'http://hl7.org/fhir/regulated-authorization-case-type'=>['InitialMAA', 'Variation', 'LineExtension', 'PSUR', 'Renewal', 'Follow-up', '100000155699', 'AnnualReassessment', 'UrgentSafetyRestriction', 'PaediatricSubmission', 'TransferMA', 'LiftingSuspension', 'Withdrawal', 'Reformatting', 'RMP', 'ReviewSuspension', 'SupplementalInformation', 'RepeatUse', 'SignalDetection', 'FLU', 'PANDEMIC', 'Orphan']}, 'type'=>'CodeableConcept', 'path'=>'Case.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'example', 'uri'=>'http://hl7.org/fhir/ValueSet/regulated-authorization-case-type'}},
          'status' => {'valid_codes'=>{'http://hl7.org/fhir/publication-status'=>['draft', 'active', 'retired', 'unknown']}, 'type'=>'CodeableConcept', 'path'=>'Case.status', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/publication-status'}},
          'datePeriod' => {'type'=>'Period', 'path'=>'Case.date[x]', 'min'=>0, 'max'=>1},
          'dateDateTime' => {'type'=>'dateTime', 'path'=>'Case.date[x]', 'min'=>0, 'max'=>1},
          'application' => {'type'=>'RegulatedAuthorization::Case', 'path'=>'Case.application', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        attr_accessor :application       # 0-* [ RegulatedAuthorization::Case ]
      end
      ...
      attr_accessor :case              # 0-1 RegulatedAuthorization::Case
