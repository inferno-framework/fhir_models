module FHIR
  module build.fhir.org
    class GraphDefinition < Model
      ...
      SEARCH_PARAMS = ['context', 'context-quantity', 'context-type', 'context-type-quantity', 'context-type-value', 'date', 'description', 'identifier', 'jurisdiction', 'name', 'publisher', 'start', 'status', 'url', 'version']
      METADATA = {
        ...
        'language' => {'type'=>'code', 'path'=>'GraphDefinition.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'identifier' => {'type'=>'Identifier', 'path'=>'GraphDefinition.identifier', 'min'=>0, 'max'=>Float::INFINITY},
        'version' => {'type'=>'string', 'path'=>'GraphDefinition.version', 'min'=>0, 'max'=>1},
        'versionAlgorithmString' => {'type'=>'string', 'path'=>'GraphDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'type'=>'Coding', 'path'=>'GraphDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        'name' => {'type'=>'string', 'path'=>'GraphDefinition.name', 'min'=>1, 'max'=>1},
        'title' => {'type'=>'string', 'path'=>'GraphDefinition.title', 'min'=>0, 'max'=>1},
        ...
        'copyright' => {'type'=>'markdown', 'path'=>'GraphDefinition.copyright', 'min'=>0, 'max'=>1},
        'copyrightLabel' => {'type'=>'string', 'path'=>'GraphDefinition.copyrightLabel', 'min'=>0, 'max'=>1},
        'start' => {'type'=>'id', 'path'=>'GraphDefinition.start', 'min'=>0, 'max'=>1},
        'node' => {'type'=>'GraphDefinition::Node', 'path'=>'GraphDefinition.node', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Node < Model
        ...
        METADATA = {
          'id' => {'type'=>'string', 'path'=>'Node.id', 'min'=>0, 'max'=>1},
          'extension' => {'type'=>'Extension', 'path'=>'Node.extension', 'min'=>0, 'max'=>Float::INFINITY},
          'modifierExtension' => {'type'=>'Extension', 'path'=>'Node.modifierExtension', 'min'=>0, 'max'=>Float::INFINITY},
          'nodeId' => {'type'=>'id', 'path'=>'Node.nodeId', 'min'=>1, 'max'=>1},
          'description' => {'type'=>'string', 'path'=>'Node.description', 'min'=>0, 'max'=>1},
          ...
          'profile' => {'type'=>'canonical', 'path'=>'Node.profile', 'min'=>0, 'max'=>1}
        }

        attr_accessor :id                # 0-1 string
        attr_accessor :extension         # 0-* [ Extension ]
        attr_accessor :modifierExtension # 0-* [ Extension ]
        attr_accessor :nodeId            # 1-1 id
      ...
      class Link < Model
        ...
        METADATA = {
          ...
          'sourceId' => {'type'=>'id', 'path'=>'Link.sourceId', 'min'=>1, 'max'=>1},
          'path' => {'type'=>'string', 'path'=>'Link.path', 'min'=>0, 'max'=>1},
          'sliceName' => {'type'=>'string', 'path'=>'Link.sliceName', 'min'=>0, 'max'=>1},
          'targetId' => {'type'=>'id', 'path'=>'Link.targetId', 'min'=>1, 'max'=>1},
          'params' => {'type'=>'string', 'path'=>'Link.params', 'min'=>0, 'max'=>1},
          'compartment' => {'type'=>'GraphDefinition::Link::Compartment', 'path'=>'Link.compartment', 'min'=>0, 'max'=>Float::INFINITY}
        }
        ...
        class Compartment < Model
          ...
          METADATA = {
            ...
            'use' => {'valid_codes'=>{'http://hl7.org/fhir/graph-compartment-use'=>['where', 'requires']}, 'type'=>'code', 'path'=>'Compartment.use', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/graph-compartment-use'}},
            ...
            'code' => {'valid_codes'=>{'http://hl7.org/fhir/compartment-type'=>['Patient', 'Encounter', 'RelatedPerson', 'Practitioner', 'Device', 'EpisodeOfCare']}, 'type'=>'code', 'path'=>'Compartment.code', 'min'=>1, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/compartment-type'}},
        ...
        attr_accessor :compartment       # 0-* [ GraphDefinition::Link::Compartment ]
      end
      ...
      attr_accessor :start                  # 0-1 id
      attr_accessor :node                   # 0-* [ GraphDefinition::Node ]
