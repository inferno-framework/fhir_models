module FHIR
  module build.fhir.org
    class ChargeItemDefinition < Model
      ...
      SEARCH_PARAMS = ['account', 'context', 'context-quantity', 'context-type', 'context-type-quantity', 'context-type-value', 'date', 'description', 'effective', 'identifier', 'jurisdiction', 'publisher', 'status', 'title', 'url', 'version']
      METADATA = {
        ...
        'language' => {'type'=>'code', 'path'=>'ChargeItemDefinition.language', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'additional'=>[{'purpose'=>'starter', 'valueSet'=>'http://hl7.org/fhir/ValueSet/languages'}], 'uri'=>'http://hl7.org/fhir/ValueSet/all-languages'}},
        ...
        'url' => {'type'=>'uri', 'path'=>'ChargeItemDefinition.url', 'min'=>0, 'max'=>1},
        ...
        'versionAlgorithmString' => {'type'=>'string', 'path'=>'ChargeItemDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1},
        'versionAlgorithmCoding' => {'valid_codes'=>{'http://hl7.org/fhir/version-algorithm'=>['semver', 'integer', 'alpha', 'date', 'natural']}, 'type'=>'Coding', 'path'=>'ChargeItemDefinition.versionAlgorithm[x]', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'extensible', 'uri'=>'http://hl7.org/fhir/ValueSet/version-algorithm'}},
        'name' => {'type'=>'string', 'path'=>'ChargeItemDefinition.name', 'min'=>0, 'max'=>1},
        ...
        'account' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Account'], 'type'=>'Reference', 'path'=>'ChargeItemDefinition.account', 'min'=>0, 'max'=>Float::INFINITY},
        ...
        'purpose' => {'type'=>'markdown', 'path'=>'ChargeItemDefinition.purpose', 'min'=>0, 'max'=>1},
        'copyright' => {'type'=>'markdown', 'path'=>'ChargeItemDefinition.copyright', 'min'=>0, 'max'=>1},
        'copyrightLabel' => {'type'=>'string', 'path'=>'ChargeItemDefinition.copyrightLabel', 'min'=>0, 'max'=>1},
        ...
        'instance' => {'type_profiles'=>['http://hl7.org/fhir/StructureDefinition/Medication', 'http://hl7.org/fhir/StructureDefinition/Substance', 'http://hl7.org/fhir/StructureDefinition/Device', 'http://hl7.org/fhir/StructureDefinition/DeviceDefinition', 'http://hl7.org/fhir/StructureDefinition/ActivityDefinition', 'http://hl7.org/fhir/StructureDefinition/PlanDefinition', 'http://hl7.org/fhir/StructureDefinition/HealthcareService'], 'type'=>'Reference', 'path'=>'ChargeItemDefinition.instance', 'min'=>0, 'max'=>Float::INFINITY},
      ...
      class Applicability < Model
        ...
        METADATA = {
          ...
          'condition' => {'type'=>'Expression', 'path'=>'Applicability.condition', 'min'=>0, 'max'=>1},
          'effectivePeriod' => {'type'=>'Period', 'path'=>'Applicability.effectivePeriod', 'min'=>0, 'max'=>1},
          'relatedArtifact' => {'type'=>'RelatedArtifact', 'path'=>'Applicability.relatedArtifact', 'min'=>0, 'max'=>1}
        }
        ...
        attr_accessor :relatedArtifact   # 0-1 RelatedArtifact
      end
      ...
      class PropertyGroup < Model
        ...
        METADATA = {
          ...
          'priceComponent' => {'type'=>'MonetaryComponent', 'path'=>'PropertyGroup.priceComponent', 'min'=>0, 'max'=>Float::INFINITY}
        }
      ...
      attr_accessor :instance               # 0-* [ Reference(Medication|Substance|Device|DeviceDefinition|ActivityDefinition|PlanDefinition|HealthcareService) ]
      attr_accessor :applicability          # 0-* [ ChargeItemDefinition::Applicability ]
